package com.thoughtbot.expandablerecyclerview.sample.addnewitems;
...
public class AddNewItemsActivity extends AppCompatActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    Button addNewItems = (Button) findViewById(R.id.toggle_button);
    addNewItems.setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View v) {
        adapter.addGroups(makeGenres());
      }
    });
  }
