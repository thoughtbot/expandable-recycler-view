...
/**
 * Interface definition for a callback to be invoked when a {@link CheckableChildViewHolder#checkable}
 * has been clicked.
 */
public interface OnChildCheckChangedListener {
   ...
   * @param flatPos The flat position (raw index) of the the child within the {@link RecyclerView}
   */
